...
def run_experiment(config_run, scenario_name, sample_name, target_col, seed_list):
    ...
    for seed in seed_list:
        ...
        mean_trail, big_df_rct, big_df_obs = data_generation(gp_params, big_n_rct, big_n_obs, target_col, data_seed + seed)
        ...
        for iter in range(len(n_rct_list)):
            ...
            ate_est, ate_ci = sim_cases(seed, df_rct, df_obs, alpha, delta, x_col)
...
if __name__ == "__main__":
    ...
    for scenario_name, sample_name in itertools.product(scenario_list, sample_list):
        run_experiment(config, scenario_name, sample_name, "Ethnics", seed_list)
